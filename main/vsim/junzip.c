...
EXT_RAM_BSS_ATTR unsigned char zipLoadBuffer[MAX_ZIP_LOAD_BUF];


EXT_RAM_BSS_ATTR unsigned char jzBuffer[JZ_BUFFER_SIZE]; // limits maximum zip descriptor size
